...
// Text  
$_['button_export']          = 'Export Selected';
...
$_['entry_bulkattent']       = '<strong>Insert</strong> : The row that model already exists cannot be insert.<br /><strong>Update</strong> : The row that model does not exist cannot be update.';
$_['entry_file']             = 'File:';
$_['entry_bulktype']         = 'Type:';
...
// Error
$_['error_noselected']       = 'Warning: You do not have selected!';
