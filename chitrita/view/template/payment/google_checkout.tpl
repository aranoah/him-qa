      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><input type="text" name="google_checkout_total" value="<?php echo $google_checkout_total; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_order_status; ?></td>
            <td><select name="google_checkout_order_status_id">
          ...
          <tr>
            ...
            <td><select name="google_checkout_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="google_checkout_sort_order" value="<?php echo $google_checkout_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
